    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 font-sans selection:bg-blue-100">
      ...
      <div className="fixed w-full top-4 md:top-6 z-50 px-4">
        <nav className="max-w-7xl w-full mx-auto backdrop-blur-xl bg-white/80 border border-gray-200/80 shadow-xl shadow-gray-200/50 rounded-3xl md:rounded-[2rem] h-16 md:h-20 flex justify-between items-center px-6 md:px-8 transition-all">
          ...
          <a href="#contact" className="md:hidden flex items-center justify-center gap-2 px-4 h-10 bg-blue-50 text-blue-600 rounded-full border border-blue-100 active:bg-blue-100 transition-colors text-sm font-bold uppercase tracking-wide">
            <IoMail size={16} /> Contatti
          </a>
        </nav>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg text-gray-500 mb-8 leading-relaxed max-w-lg">
                Appassionato di tecnologia a 360 gradi e studente di Informatica a Milano. Sono guidato da un'insaziabile curiosità per come funzionano le cose. Non mi fermo alla teoria: amo 'sporcarmi le mani', sperimentare e imparare ogni giorno qualcosa di nuovo.
              </p>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative group max-w-[500px] mx-auto">
                ...
                <div className="relative w-full aspect-square bg-white rounded-[3rem] overflow-hidden shadow-2xl transition-all duration-300">
      ...
      <section id="about" className="py-32 bg-white border-y border-gray-100 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6 w-full">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-500 max-w-md">Un breve riassunto del mio percorso, tra aule universitarie, codice e progetti pratici.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-xl text-gray-900 font-bold mb-6">
                Non mi accontento di far funzionare le cose, voglio capire perché funzionano.
              </p>
              <p className="text-lg text-gray-500 mb-6 leading-relaxed">
                Il mio percorso nasce all'istituto tecnico informatico e continua ora all'università, ma questa mentalità va ben oltre lo schermo di un computer. Che si tratti di debuggare codice o di sporcarmi le mani in garage per mettere a posto una moto, l'approccio è lo stesso: mi piace smontare un problema complesso, capire come interagiscono i vari pezzi e trovare una soluzione pratica. Sono abituato ad arrangiarmi, a imparare dai miei errori e a trasformare la teoria in pura pratica, sia nella vita di tutti i giorni che nel mondo tech.
              </p>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
                <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100">
                  <FiCode className="text-blue-600 mb-4" size={24} />
                  <h4 className="font-bold mb-1">Sviluppo & Code</h4>
                  <p className="text-sm text-gray-500">GoLang, Java, React</p>
                </div>
                <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100">
                  <FiSettings className="text-indigo-600 mb-4" size={24} />
                  <h4 className="font-bold mb-1">Sistemi & Hardware</h4>
                  <p className="text-sm text-gray-500">Linux, Raspberry Pi, Bash, Reti</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            <div>
              ...
              <p className="text-gray-500 max-w-md">Una selezione dei miei repository più recenti, sincronizzati direttamente dal mio GitHub. Scorri per visualizzare.</p>
            </div>
              ...
              projects.map((repo) => (
                <div key={repo.id} className="group w-full md:flex-none md:w-[400px] lg:w-[480px] md:snap-start flex flex-col h-auto">
                  <div className="aspect-[4/3] bg-white rounded-[2rem] mb-8 overflow-hidden relative shadow-sm border border-gray-200 shrink-0">
                    ...
                    <div className="absolute inset-0 bg-blue-600/0 group-hover:bg-blue-600/10 transition-all duration-500 z-20 pointer-events-none"></div>
                    
                    <a href={repo.html_url} target="_blank" rel="noreferrer" className="block w-full h-full bg-gray-50 relative z-10 cursor-pointer">
                    ...
                    <div className="absolute top-6 right-6 flex gap-3 z-30">
                      ...
                      <a href={repo.html_url} target="_blank" rel="noreferrer" className="p-4 bg-white border border-gray-100 rounded-full opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 shadow-xl hover:text-gray-900 delay-75">
                        <FiGithub size={24} />
                      </a>
                    </div>
                  </div>
                  
                  <a href={repo.html_url} target="_blank" rel="noreferrer" className="inline-block w-max">
      ...
      <section id="lab" className="py-32 bg-white scroll-mt-20 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="mb-12">
            ...
            <p className="text-gray-500 max-w-md">I miei esperimenti fuori da GitHub: il mio laboratorio personale.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="p-8 border-2 border-dashed border-gray-200 rounded-[2.5rem] hover:border-indigo-300 transition-colors group bg-gray-50">
              ...
              <h3 className="text-xl font-bold mb-3 italic text-gray-800 tracking-tight text-center">Progetto Garage</h3>
              <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                Il troubleshooting non si fa solo davanti a uno schermo. Nel tempo libero mi dedico alla manutenzione e sistemazione della mia moto. Identificare un guasto, smontare i pezzi e sporcarsi le mani per rimetterla in strada richiede la stessa identica logica del debug.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="bg-white border border-gray-200 text-gray-600 text-[10px] font-bold px-2 py-1 rounded uppercase">Troubleshooting</span>
                <span className="bg-white border border-gray-200 text-gray-600 text-[10px] font-bold px-2 py-1 rounded uppercase">Problem Solving</span>
              </div>
            </div>
            ...
            <div className="p-8 border-2 border-dashed border-gray-200 rounded-[2.5rem] hover:border-indigo-300 transition-colors group bg-gray-50">
              ...
              <h3 className="text-xl font-bold mb-3 italic text-gray-800 tracking-tight text-center">Home Network & Sicurezza</h3>
              <p className="text-gray-500 text-sm mb-6 leading-relaxed">
                Ho trasformato un Raspberry Pi nel cuore della mia rete domestica. Gestisco il traffico DNS bloccando le pubblicità a livello di rete con Pi-hole e accedo alla mia LAN da remoto, in totale sicurezza, tramite un server VPN WireGuard e un server SSH.
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <span className="bg-white border border-gray-200 text-gray-600 text-[10px] font-bold px-2 py-1 rounded uppercase">Wireguard</span>
      ...
      <footer id="contact" className="bg-gray-800 py-32 border-t border-gray-800 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-6 w-full text-center">
          <h2 className="text-5xl md:text-7xl font-black mb-12 tracking-tighter leading-none text-white">
            Ti interessa il mio profilo? <br />
            <span className="text-blue-500">Mettiamoci in contatto.</span>
          </h2>
